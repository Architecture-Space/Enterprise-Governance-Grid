#!/usr/bin/env node
/**
 * Regenerate docs/strategy/strategic-questions/SQ*.md from the demo JSON source of truth.
 */
...
function md(q) {
  ...
  lines.push(`| Demo | [/demo/customer360/questions?q=${q.code}](https://architecture-space.github.io/Enterprise-Governance-Grid/demo/customer360/questions?q=${q.code}) (Strategic Qs page) |`)
  lines.push('')
